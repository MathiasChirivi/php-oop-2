                ...
                <?php foreach ($PlaysListDog as $play) { ?>
                    <div class="d-flex">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <p class="card-text m-0">Categoria: <?= $play->category->icon; $play->category->name ?></p>
                ...
                <?php foreach ($DogsBedList as $Dogbed) { ?>
                    <div class="d-flex">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <p class="card-text m-0">Categoria: <?= $Dogbed->category->icon; $Dogbed->category->name ?></p>
                    ...
                    <div class="d-flex">
                        <div class="card" style="width: 18rem;">
                            ...
                            <p class="card-text m-0">Categoria: <?= $food->category->icon; $food->category->name ?></p>
                                <p class="card-text"><strong>Gioco:</strong> <?= $food->name ?></p>
                                <p class="card-text"><strong>Prezzo Gioco:</strong> <?= $food->getPrice() ?></p>
                                <p class="card-text"><strong>Descrizione Gioco:</strong> <?= $food->description ?></p>
                                <p class="card-text"><strong>Dimensione Cuccia:</strong> <?= $food->ingredients ?></p>
                                <a href="#" class="btn btn-primary">Acquista Prodotto</a>
                            </div>
                        </div>
                    </div>
